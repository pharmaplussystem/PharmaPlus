const CACHE='pharmaplus-management-v14-locfix4';
self.addEventListener('install',e=>e.waitUntil(caches.open(CACHE).then(c=>c.addAll(['./','./index.html','./manifest.json','./config.js','./medicine-pattern.svg'])).then(()=>self.skipWaiting())));
